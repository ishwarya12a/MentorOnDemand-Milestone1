...
<div class="container-fuild">
        ...
        <form class="form-horizontal" action="/updatecompany" modelAttribute="update">
...
%>
      ...
      <div class="col-sm-4"><a href="updatecompany?id=<%= technology.getRegCode() %>"  class="btn btn-primary">Send Proposal</a></div>
      </div>
      </div></td>  
      </tr>
      <% }%>       
